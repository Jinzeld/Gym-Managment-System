<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $class_id = mt_rand(100, 999); // Generate random 3-digit class ID
...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <p><b>Instructions: </b> Select the name of the instructor you want to assign to the new class.</p>
            <p>After selecting an instructor, enter a class name, pick the class days and time, and enter a class size.</p>

...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <h1>Welcome, Admin_001</h1>
            <p><b>Instruction: </b>As an admin, you can modify members, memberships, classes, and instructors. For each table below, there will be a green at the top that lets
             you add a member, membership, instructor, or class depending on which table. Each table also features an 'Action' column that contains tools that lets you 
             add, view, update, or remove data corresponding to the table row.</p>
            <div class="image-container">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            if ($result = mysqli_query($link, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='addClass.php?member_id=" . $row['member_id'] . "' title='Assign Class' data-toggle='tooltip'><span class='glyphicon glyphicon-plus'></span></a>";
                        ...
                        ?>
                        <div class="page-header clearfix">
                            <h2 class="pull-left">Membership</h2>
                            <a href="newMembership.php" class="btn btn-success pull-right">Add New Membership</a>
                        </div>
                        <?php
                            ...
                            if ($result2 = mysqli_query($link, $sql2)) {
                                if (mysqli_num_rows($result2) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result2)) {
                                        ...
                                        echo "<td>" . $row['type'] . "</td>";
                                        echo "<td>";
                                        echo "<a href='updateMembership.php?member_id=" . $row['member_id'] . "' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                        echo "<a href='deleteMembership.php?member_id=" . $row['member_id'] . "' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";

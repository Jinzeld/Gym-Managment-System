...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            ...
            <p><b>Instructions: </b> To add a new instructor, enter their full name, email address, and what sport/exercise they specialize in.</p><br>
            <p>Please fill out the form to add a new instructor. All fields cannot be empty.</p><br>
